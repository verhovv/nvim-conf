...
-- Нумерация строк
vim.wo.number = true      -- Показывает абсолютные номера строк
vim.wo.relativenumber = false -- Показывает номера строк относительно текущей
vim.wo.cursorline = true  -- Подсвечивает текущую строку
